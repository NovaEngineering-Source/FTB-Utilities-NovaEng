...
tasks.jar.configure {
    archiveBaseName.set("${project.name}-NovaEng")
    manifest {
...
//    accessTransformerFiles.from("src/main/resources/META-INF/ftblib_at.cfg")
//}
...
//    compileOnly(rfg.deobf("curse.maven:modularmachinery-community-edition-817377:4991928"))
    implementation(files("libs/FTB-Library-NovaEng-5.5.0-dev.jar"))
    compileOnly(rfg.deobf("curse.maven:kubejs-238086:3052392"))
    compileOnly(rfg.deobf("curse.maven:aurora-342117:2817929"))
    compileOnly(rfg.deobf("curse.maven:ichunutil-229060:2801262"))
    compileOnly(rfg.deobf("curse.maven:journeymap-32274:5172461"))
    compileOnly(rfg.deobf("curse.maven:chisels-bits-231095:2720655"))
